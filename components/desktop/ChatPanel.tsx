  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8">
        <h2
          className="anim-crt-flicker text-center font-mono text-xl font-bold uppercase tracking-widest text-crit"
      ...
      <div className="flex flex-col gap-2 px-5 pb-4 pt-2">
        ...
        {systemLocked ? (
          ...
          <>
            <form
              onSubmit={onSubmit}
              className="clip-console flex items-end gap-3 border border-border-hi p-3"
              style={{
            ...
            >
              ...
              <button
                ...
                className="clip-btn flex h-9 shrink-0 items-center gap-1.5 bg-signal px-4 font-tech text-xs font-bold tracking-[0.18em] text-bg-deep shadow-[0_0_20px_rgba(61,212,200,0.4)] transition-opacity disabled:cursor-not-allowed disabled:opacity-40"
              >
                <span>TRANSMIT</span>
...
function EmptyState({ onSelect, disabled }: EmptyStateProps) {
  return (
    <div className="mx-auto flex h-full min-h-fit max-w-3xl flex-col items-center justify-center gap-5 px-4 py-6 text-center">
      <HoloCore size={300} labels />

      <div>
        <h1 className="anim-crt-blip font-disp text-[38px] uppercase tracking-[0.3em] text-signal-active [text-shadow:0_0_22px_rgba(61,212,200,0.45),0_0_60px_rgba(61,212,200,0.18)]">
          Samuel<span className="text-info-hot [text-shadow:0_0_22px_rgba(200,144,32,0.5)]">_</span>OS
        </h1>
        <p className="mt-2.5 font-mono text-[9.5px] uppercase tracking-[0.5em] text-muted">
      ...
      <div className="flex justify-center gap-3 pb-1">
        {SEED_PROMPTS.map((p) => (
          <button
            ...
            className="clip-chip flicker-on-hover shrink-0 border border-border bg-panel px-4 py-2.5 text-left transition-colors hover:border-border-hi hover:bg-panel-hi disabled:cursor-not-allowed disabled:opacity-50"
          >
