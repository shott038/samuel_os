          ...
          >
            ...
            <article className="viewer-scanline scroll-system flex-1 overflow-y-auto">
              <motion.div
                ...
                className="relative z-10 px-6 py-6 sm:px-8 sm:py-8"
              >
                <header
                  className="pb-5"
          ...
          <AnimatePresence>
            {lightbox && (
              <motion.div
                ...
                className="fixed inset-0 z-[60] flex flex-col items-center justify-center bg-black/95 backdrop-blur-md p-4 sm:p-8 cursor-zoom-out"
              >
                <motion.img
                  key={lightbox.src}
